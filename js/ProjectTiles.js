...
_PROJECTS = [
    // in development
    new Tile("sentaku!", "A singleplayer text-based puzzle game", "coding, puzzle design", "https://github.com/murkbone/sentaku", "web_fpr", "list_unreleased", true, true),
    
    // may 2022
    new Tile("Auxilium", "A singleplayer/cooperative puzzle game. Project was cancelled.", "coding", "https://github.com/murkbone/Auxilium", "web_fpr", "list_2022_may", true, true),
    
    // april 2022
    new Tile("boot9strap", "Third-party CFW code executor", "establishing concept", "https://github.com/murkbone/boot9strap", "web_fpr", "list_2022_april", true, true),
    new Tile("arm9loaderhax", "Free-to-download powerful Auxilium modding tools", "establishing concept, helping with tools", "https://github.com/murkbone/arm9loaderhax", "web_fpr", "list_2022_april", true, true),
    
    // march 2022
    new Tile("JesusAI", "a batch game involving Jesus, debugging features and 4 endings", "co-developing, recoding parts of the game", "https://github.com/murkbone/JesusAI", "web_fpr", "list_2022_march", true, true),
    new Tile("JesusAI Cartridges", "optional DLC that can run from JesusAI", "coding", "https://github.com/murkbone/JesusAI-Cartridges", "web_fpr", "list_2022_march", true, true),
    new Tile("Flip a Coin", "An experimental tech demo about, you guessed it, flipping a coin", "coding, creating number generator methods", "https://github.com/murkbone/Flip-a-Coin", "web_fpr", "list_2022_march", true, true),
    
    // february 2022
    new Tile("Make a SPECIL Valentine!", "A text-based dating sim about finding true love", "coding the entire game", "https://github.com/murkbone/Make-a-SPECIL-Valentine", "web_fpr", "list_2022_february", true, true),
    
    // january 2022
    new Tile("Unix Epoch", "Easy to use mod loader + injector for JesusAI", "coding, writing injection methods", "https://github.com/murkbone/Unix-Epoch", "web_fpr", "list_2022_january", true, true),
    
    // december 2021
    new Tile("abyss (Scrapped)", "a game of descending layers to find... something", "coding", "https://github.com/murkbone/ABANDONED-abyss", "web_fpr", "list_2021_december", false, true), 
    new Tile("Fiberopt (Scrapped)", "A short Batch game about loneliness", "coding", "https://github.com/murkbone/Fiberopt", "web_fpr", "list_2021_december", false, true),
]
